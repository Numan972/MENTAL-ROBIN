...
# Decompiled By MENTAL ROBIN

# Github : https://github.com/numan972

# uncompyle6 version 

# Original written By MENTAL ROBIN
...
__copyright = 'All rights reserved . Copyright  MENTAL ROBIN'
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
         ...
         #   os.system('xdg-open https://www.facebook.com/LOM.CEO.HETTERS.REAL.DAD.ROBIN')
...
def action():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[92m  [ROBIN_OK]  ' + k + c + user + '  |  ' + pass1
                ...
                print '\x1b[1;91m  [ROBIN_CP] ' + k + c + user + '  |  ' + pass1
                ...
                if 'access_token' in q:
                    ...
                    print '\x1b[1;92m  [ROBIN_OK] ' + k + c + user + '  |  ' + pass2
                    ...
                    print '\x1b[1;91m  [Robin_CP] ' + k + c + user + '  |  ' + pass2
                    ...
                    if 'access_token' in q:
                        ...
                        print '\x1b[1;92m  [ROBIN_OK]  ' + k + c + user + '  |  ' + pass3
                        ...
                        print '\x1b[1;91m  [ROBIN_CP] ' + k + c + user + '  |  ' + pass3
    ...
    print '\r [%s%s%s] MK-302: %s/%s OK-:%s - CP-:%s '%(H,datetime.now().strftime('%H:%M:%S'),N,loop,len(self.id),len(ok),len(cp)),
    ...
    raw_input('\n\x1b[1;97m[\x1b[1;98mROBIN_menu_Back\x1b[1;95m]')
